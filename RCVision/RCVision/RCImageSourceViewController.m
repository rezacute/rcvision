...
#import "RCImageSourceViewController.h"
#import <RESideMenu/RESideMenu.h>

@interface RCImageSourceViewController (){
    NSArray *titles;
}
@property (strong, readwrite, nonatomic) UITableView *tableView;
@end

@implementation RCImageSourceViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        case 0:
            [RCController sharedInstance].currentImage = [UIImage imageNamed:@"Balloon"];
            
            break;
        case 1:
            [RCController sharedInstance].currentImage = [UIImage imageNamed:@"Background"];
